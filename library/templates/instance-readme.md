---
# This file is generated by new-instance.ps1. Keep it up to date manually as
# decisions are ratified. It is also the "Manifest" link target from every page footer.
---
...
|---|---|
| **Archetype** | <A1 \| A2 \| A3> |
| **Sovereignty** | standard \| regulated |
